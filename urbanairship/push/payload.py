...
def notification(alert=None, ios=None, android=None, amazon=None,
    ...
    :keyword interactive: An :py:func:`interactive` object or json object that
        with two attributes -- "type" and "button_actions".
...
def amazon(alert=None, consolidation_key=None, expires_after=None, extra=None,
    ...
    :keyword interactive: An :py:func:`interactive` object or json object with
        two attributes -- "type" and "button_actions".
