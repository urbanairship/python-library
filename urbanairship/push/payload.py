...
def in_app(alert, display_type, expiry=None, display=None, actions=None, interactive=None, extra=None):
    ...
    :param display_type: Required, string
    :param expiry: Optional, String specifying an expiry value.
    :param display: Optional, A dictionary specifying the display_ appearance of the in-app message.
    :param actions: Optional, Used to perform a defined task.
    :param interactive: Optional, A dictionary with two attributes – “type” and “button_actions”, as generated by interactive().
    :param extra: Optional, Object.
