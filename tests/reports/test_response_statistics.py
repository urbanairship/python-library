...
class TestResponseList(unittest.TestCase):
    ...
    def test_response_list(self):
        ...
        self.assertEqual(
            push_responses[0].push_uuid, self.uuid1)
        self.assertEqual(push_responses[0].sends, 0)
        self.assertEqual(
            push_responses[0].push_time,
