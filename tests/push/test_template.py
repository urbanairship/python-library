...
class TestTemplatePush(unittest.TestCase):
    def test_full_payload(self):
        ...
        p.merge_data = ua.merge_data(
            ...
            substitutions={"FIRST_NAME": "Bob", "LAST_NAME": "Smith", "TITLE": ""},
        )
        ...
        self.assertEqual(
            p.payload,
            {
                ...
                "audience": {"ios_channel": "b8f9b663-0a3b-cf45-587a-be880946e881"},
            },
        )
...
class TestTemplate(unittest.TestCase):
    def test_template_lookup1(self):
        ...
        self.assertEqual(
            airship.urls.get("templates_url") + template_id,
                    ...
                    "templates": [
                        {
                            ...
                            "push": {
                                "notification": {
                                    "alert": "Hello {{FIRST_NAME}}, this is " "a test"
                                }
                            },
                            "last_used": None,
                        },
    ...
    def test_template_creation_payload(self):
        ...
        t.push = {
            "notification": {"alert": "Hi {{TITLE}} {{FIRST_NAME}} {{LAST_NAME}}!"}
        }
    ...
    def test_create_template(self):
        ...
        push = {"notification": {"alert": "Hi {{TITLE}} {{FIRST_NAME}} {{LAST_NAME}}!"}}
    ...
    def test_update_template(self):
        ...
        push = {
            "notification": {"alert": "Bye {{TITLE}} {{FIRST_NAME}} {{LAST_NAME}}!"}
        }

        with mock.patch.object(ua.Airship, "_request") as mock_request:
            response = requests.Response()
            response._content = json.dumps(
                {"ok": True, "operation_id": "9ce808c8-7176-45dc-b79e-44aa74249a5a"}
            ).encode("utf-8")
            response.status_code = 200
            mock_request.return_value = response
    ...
    def test_delete_template(self):
        ...
        with mock.patch.object(ua.Airship, "_request") as mock_request:
            response = requests.Response()
            response._content = json.dumps(
                {"ok": True, "operation_id": "a6394ff8-8a65-4494-ad06-677eb8b7ad6a"}
            ).encode("utf-8")
            response.status_code = 200
            mock_request.return_value = response
