...
class TestMessage(unittest.TestCase):
    def test_simple_alert(self):
        self.assertEqual(ua.notification(alert="Hello"), {"alert": "Hello"})
    ...
    def test_wns_payload(self):
        ...
        self.assertRaises(ValueError, ua.wns_payload, alert="Hello", tile="Foo")
    ...
    def test_rich_push(self):
        ...
        self.assertEqual(
            ua.message(title="My Title", body="My Body"),
    ...
    def test_wearable(self):
        ...
        self.assertEqual(
            ua.android(alert="android alert", local_only=False, wearable=wearable),
            {
                "alert": "android alert",
                "local_only": False,
                "wearable": {
    ...
    def test_public_notification(self):
        public_notification = ua.public_notification(
            alert="An alert", title="A title", summary="A summary"
        )

        self.assertEqual(
            public_notification,
            {"title": "A title", "alert": "An alert", "summary": "A summary"},
        )
