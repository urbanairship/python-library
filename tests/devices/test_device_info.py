...
class TestDeviceInfo(unittest.TestCase):
    ...
    def test_channel_lookup(self):
        with mock.patch.object(ua.Airship, "_request") as mock_request:
            ...
            last_registration_date = datetime.datetime.strptime('2014-08-11T20:47:28', '%Y-%m-%dT%H:%M:%S')
            ...
            self.assertEqual(channel_lookup.last_registration, last_registration_date)
